...
public class TagViewer extends ActionBarActivity {
    ...
    private String dumpTagData(Parcelable p) {
        ...
        uid = Long.toString(getReversed(id));
    ...
    void buildTagViews(NdefMessage[] msgs) {
        ...
        if(extras != null){
        	String c = extras.getString("scanmode");
        	if(c.equals("create")){
        		Bundle g = new Bundle();
        		g.putString("tagid",uid);
        		Intent a = new Intent(TagViewer.this,CreateActivity.class);
        		a.putExtras(g);
        		startActivity(a);
        	}else{
        		//Save
